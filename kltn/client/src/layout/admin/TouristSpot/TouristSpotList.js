...
import { getTouristSpots, deleteTouristSpot } from '../../../api/touristSpotsApi';
import './TouristSpot.css';

const TouristSpotList = ({ setCurrentView, setEditId }) => {
  ...
  const handleDelete = async (id) => {
    try {
      ...
      alert('Có lỗi xảy ra khi xóa địa điểm du lịch');
    }
  };
      ...
      <div className="container-xxl">
        <div className="align-items-end row g-4 mb-4" data-aos="fade-down">
          ...
          <div className="col-12 col-xl-auto">
            <button onClick={() => setCurrentView('add')} className="btn btn-primary-soft">
              <i className="fa fa-plus me-2"></i> Thêm Địa Điểm Du Lịch
            </button>
          </div>
        </div>
